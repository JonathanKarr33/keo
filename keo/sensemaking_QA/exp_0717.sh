...
python generate_answers.py \
    ...
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-it100.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-it100 \
    --provider openai \
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-it300.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-it300 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-itcum_200.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-itcum200 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-itcum_300.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-itcum300 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-itcum_400.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-itcum400 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_phi4mini-it/answers_gemma-3-27b-it_kg_phi4mini-itcum_500.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_phi4mini-itcum500 \
    --provider openai \
    --evaluation-model gpt-4o