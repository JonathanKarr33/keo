...
python generate_answers.py \
    ...
    --output-file ./output/kg_gpt-4o/answers_gemma-3-27b-it_kg_gpt-4ocum_400.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_gpt-4ocum400 \
    --provider openai \
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_gemma-3-27b-it_kg_gpt-4ocum_500.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_gemma-3-27b-it_evaluator_gpt-4o_kg_gpt-4ocum500 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/answers_phi-4-14b_kg_gs100.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gs100 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_phi-4-14b_kg_gpt-4o100.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gpt-4o100 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_phi-4-14b_kg_gpt-4o300.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gpt-4o300 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_phi-4-14b_kg_gpt-4ocum_200.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gpt-4ocum200 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_phi-4-14b_kg_gpt-4ocum_300.json \
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gpt-4ocum300 \
    --provider openai \
    --evaluation-model gpt-4o
...
python generate_answers.py \
    --question-files ./output/aviation_sensemaking_questions.json \
    --output-file ./output/kg_gpt-4o/answers_phi-4-14b_kg_gpt-4ocum_400.json \
    --kg-path ../kg/output/kg_llm/gpt4o_with_nodes_batches/cum_400/gpt4o_withprevnodes_cum_400_with_entity_mentions_fixed.gml \
    --answer-model microsoft/phi-4 \
    --provider huggingface \
    --API-provider nebius
...
python run_evaluation.py \
    ...
    --output-dir ./evaluation_results/answer_phi-4-14b_evaluator_gpt-4o_kg_gpt-4ocum400 \
    --provider openai \
    --evaluation-model gpt-4o
